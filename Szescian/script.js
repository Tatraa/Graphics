const generateCube = function(sideLength, vertexColors){
    const vertices = [
      // Top
      -sideLength, sideLength, -sideLength,     vertexColors, vertexColors, vertexColors+0.25, 
      -sideLength, sideLength, sideLength,      vertexColors, vertexColors, vertexColors+0.25,
      sideLength, sideLength, sideLength,       vertexColors, vertexColors, vertexColors+0.25,
      sideLength, sideLength, -sideLength,      vertexColors, vertexColors, vertexColors+0.25,
      // Left
      -sideLength, sideLength, sideLength,      vertexColors, vertexColors+0.25, vertexColors,
      -sideLength, -sideLength, sideLength,     vertexColors, vertexColors+0.25, vertexColors,
      -sideLength, -sideLength, -sideLength,    vertexColors, vertexColors+0.25, vertexColors,
      -sideLength, sideLength, -sideLength,     vertexColors, vertexColors+0.25, vertexColors,
      // Right
      sideLength, sideLength, sideLength,       vertexColors+0.25, vertexColors, vertexColors,
      sideLength, -sideLength, sideLength,      vertexColors+0.25, vertexColors, vertexColors,
      sideLength, -sideLength, -sideLength,     vertexColors+0.25, vertexColors, vertexColors,
      sideLength, sideLength, -sideLength,      vertexColors+0.25, vertexColors, vertexColors,
      // Front
      sideLength, sideLength, sideLength,       vertexColors, vertexColors, vertexColors+0.5,
      sideLength, -sideLength, sideLength,      vertexColors, vertexColors, vertexColors+0.5,
      -sideLength, -sideLength, sideLength,     vertexColors, vertexColors, vertexColors+0.5,
      -sideLength, sideLength, sideLength,      vertexColors, vertexColors, vertexColors+0.5,
      // Back
      sideLength, sideLength, -sideLength,      vertexColors, vertexColors+0.5, vertexColors,
      sideLength, -sideLength, -sideLength,     vertexColors, vertexColors+0.5, vertexColors,
      -sideLength, -sideLength, -sideLength,    vertexColors, vertexColors+0.5, vertexColors,
      -sideLength, sideLength, -sideLength,     vertexColors, vertexColors+0.5, vertexColors,
      // Bottom
      -sideLength, -sideLength, -sideLength,    vertexColors+0.5, vertexColors, vertexColors,
      -sideLength, -sideLength, sideLength,     vertexColors+0.5, vertexColors, vertexColors,
      sideLength, -sideLength, sideLength,      vertexColors+0.5, vertexColors, vertexColors,
      sideLength, -sideLength, -sideLength,     vertexColors+0.5, vertexColors, vertexColors,
    ];

    // W taki sposób myśle że by wyglądało ale nie wiem jak to dodać żeby działało :-(
